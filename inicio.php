...
echo"<center><font color='black' size='7'><p class='small text-uppercase'>BIENVENIDO ", $_SESSION['user'], "</p></font></center>";
echo'<br>';
echo'<center><img src="imagenes/banco.jpg" width="500" height="100"></center>';
echo'<br>';
...
echo'<br>';
echo'<center>';
echo'<label style="font-size: 14pt; color:  black;"><b>Solo puedes ingresar un monto de hasta $100.000 pesos</b></label><br>';
